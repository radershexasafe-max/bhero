...
class _PosScreenState extends State<PosScreen> {
  ...
  String _friendlyError(
    Object error, {
    String fallback = 'Check your internet connection and tap Reload to try again.',
  }) {
  ...
  String? _friendlyLoadError(Object error, {String? fallback}) {
    final message = ApiClient.friendlyError(
      error,
      fallback: fallback ?? 'Check your internet connection and tap Reload to try again.',
    ).trim();
    if (message.isEmpty) return fallback ?? 'Check your internet connection and tap Reload to try again.';
    return message;
  }
  ...
  Future<void> _shareReceiptPdf(String pdfPath, String saleNumber) async {
    await Share.shareXFiles(
      [XFile(pdfPath)],
      text: 'Receipt $saleNumber from T.One',
    );
  }
  ...
  Widget _baleShortcutCard(Map<String, dynamic> bale) {
    final meta = _quickBaleMetaCompact(bale);
    return SizedBox(
      width: 292,
      child: InkWell(
        ...
        child: Ink(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xFFE31B23), width: 1.2),
            boxShadow: [
              BoxShadow(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              Container(height: 1, color: const Color(0xFFFFD2D4)),
              const SizedBox(height: 12),
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
