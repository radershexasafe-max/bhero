    ...
    try {
      ...
      _showMessage(
        ApiClient.friendlyError(
          e,
          fallback: 'Could not load bale reports right now. Refresh to try again.',
        ),
        error: true,
      );
    } finally {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(color: Colors.white.withOpacity(0.92), fontSize: 15, height: 1.3),
                      ),
                    ],
                  ),
                ),
