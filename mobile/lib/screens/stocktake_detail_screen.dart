...
class _StockTakeDetailScreenState extends State<StockTakeDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return MobilePageScaffold(
      ...
      child: _loadError != null && stocktake == null && !_loading
          ? MobileRetryState(
              icon: Icons.wifi_off_rounded,
              title: 'Stock Take Is Offline',
              message: _loadError!,
              onRetry: _load,
            )
          : ListView(
        ...
        children: [
          ...
          if (_loadError != null && stocktake != null) ...[
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.wifi_off_rounded, color: Color(0xFFB71C1C)),
